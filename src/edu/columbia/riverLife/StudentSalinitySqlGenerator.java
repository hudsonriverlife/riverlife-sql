...
public class StudentSalinitySqlGenerator {
	...
	protected void processDataLine(String line, BufferedWriter writer) throws IOException {
		...
		sql.append("insert into riverlife.student_salinity ( salinity_time, total_salinity_ppm, notes, site_sampling_id, salinity_method_id) values (");
	...
	public void processFile(String inputFile) {
		try {
			...
			String line;
			int i=0;
			BufferedWriter writer = new BufferedWriter(new FileWriter("../../../../sql/2021/2021StudentSalinity.sql"));
	...
	public static void main(String args[]) {
		String inputFile="csv/2021_studentsalinity_updated.csv";
